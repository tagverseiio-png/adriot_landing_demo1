      ...
      <section className="about" id="trusted" style={{ textAlign: "center" }}>
        <div className="wrap">
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "15px", marginBottom: "20px" }}>
            ...
            <p style={{ color: "#050505", margin: 0, letterSpacing: "2px", fontSize: "14px", fontWeight: "600" }}>TRUSTED BY LEADING BUSINESSES</p>
            <span style={{ width: "40px", height: "1px", backgroundColor: "#050505" }}></span>
          </div>
          <p style={{ maxWidth: "600px", margin: "0 auto 40px", fontSize: "20px", color: "#050505", fontWeight: "700", lineHeight: "1.75" }}>
