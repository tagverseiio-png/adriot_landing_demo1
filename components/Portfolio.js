    ...
    <section className="portfolio" id="projects">
      <div className="wrap">
        <div className="section-head" style={{ maxWidth: "100%" }}>
          ...
          <h2 style={{ lineHeight: 1.2, maxWidth: "100%", fontSize: "25px", fontWeight: "600" }}> Explore projects where Adroit united design, engineering, and execution to deliver success.</h2>
        </div>
